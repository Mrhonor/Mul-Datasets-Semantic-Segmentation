...
class ContextPath(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.swin_transformer = SwinTransformer(embed_dim=96,
                                                depths=[2, 2, 6, 2],
                                                num_heads=[3, 6, 12, 24],
                                                window_size=7,
                                                ape=False,
        ...
        self.arm16 = AttentionRefinementModule(384, 128)
        self.arm32 = AttentionRefinementModule(768, 128)
        self.conv_head32 = ConvBNReLU(128, 128, ks=3, stride=1, padding=1)
        self.conv_head16 = ConvBNReLU(128, 128, ks=3, stride=1, padding=1)
        self.conv_avg = ConvBNReLU(768, 128, ks=1, stride=1, padding=0)
    ...
    def forward(self, x):
        feat8, feat16, feat32 = self.swin_transformer(x)
...
class BiSeNetV1_Swin(nn.Module):

    def __init__(self, n_classes, aux_mode='train', *args, **kwargs):
        super(BiSeNetV1_Swin, self).__init__()
        self.cp = ContextPath()
        self.sp = SpatialPath()
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        print('inference consume {} ms.'.format(start.elapsed_time(end)))
