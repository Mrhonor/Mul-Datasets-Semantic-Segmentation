...
def parse_args():
    ...
    parse.add_argument('--config', dest='config', type=str, default='configs/ltbgnn_7_datasets_snp_train_finetune.json',)
...
def train():
    ...
    for i in range(1):
        ## model
        net = set_model(configer=configer, pth=f'res/celoss/pretrain_model_10000.pth')
        if is_distributed():
