...
parse.add_argument('--img_path', dest='img_path', type=str, default='20180807145028_camera_frontcenter_000000127.png',)
...
labels_info_eval = [
    ...
    {"name": "Utility vehicle 1", "color": [255, 255, 0], "trainId": 19},
    {"name": "Sidebars", "color": [233, 100, 0], "trainId": 20},
    {"name": "Speed bumper", "color": [110, 110, 0], "trainId": 21},
    {"name": "Curbstone", "color": [128, 128, 0], "trainId": 22},
    {"name": "Solid line", "color": [255, 193, 37], "trainId": 23},
    {"name": "Irrelevant signs", "color": [64, 0, 64], "trainId": 24},
    {"name": "Road blocks", "color": [185, 122, 87], "trainId": 25},
    {"name": "Tractor", "color": [0, 0, 100], "trainId": 26},
    {"name": "Non-drivable street", "color": [139, 99, 108], "trainId": 27},
    {"name": "Zebra crossing", "color": [210, 50, 115], "trainId": 28},
    {"name": "Obstacles / trash", "color": [255, 0, 128], "trainId": 29},
    {"name": "RD restricted area", "color": [150, 0, 150], "trainId": 30},
    {"name": "Animals", "color": [204, 255, 153], "trainId": 31},
    {"name": "Signal corpus", "color": [33, 44, 177], "trainId": 32},
    {"name": "Drivable cobblestone", "color": [180, 50, 180], "trainId": 33},
    {"name": "Electronic traffic", "color": [255, 70, 185], "trainId": 34},
    {"name": "Slow drive area", "color": [238, 233, 191], "trainId": 35},
    {"name": "Parking area", "color": [150, 150, 200], "trainId": 36},
    {"name": "Painted driv. instr.", "color": [200, 125, 210], "trainId": 37},
    {"name": "Traffic guide obj.", "color": [159, 121, 238], "trainId": 38},
    {"name": "Dashed line", "color": [128, 0, 255], "trainId": 39},
    {"name": "Ego car", "color": [72, 209, 204], "trainId": 40},
]
