...
def train():
    ...
    for i in range(starti, configer.get('lr','max_iter') + starti):
        ...
        with amp.autocast(enabled=configer.get('use_fp16')):
            ...
            if is_distributed():
                out['prototypes'] = net.module.prototypes
            
            else:
                out['prototypes'] = net.prototypes
            ...
            backward_loss, loss_seg, loss_aux, loss_contrast, loss_domain, new_proto = contrast_losses(out, lb, dataset_lbs, is_warmup)
