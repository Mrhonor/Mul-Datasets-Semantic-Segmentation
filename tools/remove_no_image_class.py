...
#     # index = 0
#     for l in f:
#         no_image = int(l.split(' ')[2])
#         # print(no_image - index)
#         # print("len(labels_info): ", len(labels_info))
#         labels_info[no_image]['trainId'] = 255
#         # index += 1
        
index = 0
for i in range(0, len(labels_info)):
    if labels_info[i]['trainId'] != 255:
        labels_info[i]['trainId'] = index
        index += 1   

    # for label in labels_info:
with open('out.txt', 'w') as wf:
    for label in labels_info:
        wf.write('{' + "\"name\": \"" + label['name'] + "\", \"id\": " + str(label['id']) + ", \"color\": " + str(label['color']) + ", \"trainId\": " + str(label['trainId']) + '},\n')