...
from lib.module.gen_graph_node_feature import gen_graph_node_feature_test
...
def parse_args():
    ...
    parse.add_argument('--config', dest='config', type=str, default='configs/camvid.json',)
...
def eval_wd():
    ...
    # graph_node_features = gen_graph_node_feature_test(configer).cuda()
    ...
    heads, mious = eval_model_unseen(configer, net)
